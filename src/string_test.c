...
int main(void) {
  ...
  tcase_add_test(tc1_1, s21_insert_f);
  tcase_add_test(tc1_1, test_insert_1);
  tcase_add_test(tc1_1, test_insert_2);
  tcase_add_test(tc1_1, test_insert_3);
  tcase_add_test(tc1_1, test_insert_4);
  tcase_add_test(tc1_1, test_insert_5);
  tcase_add_test(tc1_1, test_insert_6);
  tcase_add_test(tc1_1, test_insert_7);
  tcase_add_test(tc1_1, test_insert_8);
  tcase_add_test(tc1_1, test_insert_9);
  tcase_add_test(tc1_1, test_insert_10);

  tcase_add_test(tc1_1, test_trim_1);
  tcase_add_test(tc1_1, test_trim_2);
  tcase_add_test(tc1_1, test_trim_3);
  tcase_add_test(tc1_1, test_trim_4);
  tcase_add_test(tc1_1, test_trim_5);
  tcase_add_test(tc1_1, test_trim_6);
  tcase_add_test(tc1_1, test_trim_7);
  tcase_add_test(tc1_1, test_trim_8);
  tcase_add_test(tc1_1, test_trim_9);
  tcase_add_test(tc1_1, test_trim_10);
